...
let SystemSettingsService = SystemSettingsService_1 = class SystemSettingsService {
    ...
    async updateSettings(updateDto) {
        const settings = await this.settingsModel.findOneAndUpdate({}, { $set: updateDto }, { new: true, upsert: true }).exec();
...
exports.SystemSettingsService = SystemSettingsService = SystemSettingsService_1 = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(system_settings_schema_1.SystemSettings.name)),
